...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-fluent"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-fluent/iso-profile
"
echo
